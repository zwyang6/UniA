...
class COCODataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_path = os.path.join(self.img_dir, self.stage, name + ".jpg")
        ...
        label_path = os.path.join(self.seg_dir, self.stage, name_ + ".png")
...
class COCOClsDataset(COCODataset):
    ...
    def __getitem__(self, index):
        name = self.name_list[index]
        pil_image = pil_loader(os.path.join(self.img_dir, self.stage, name + ".jpg"))
        ...
        if self.aug:
            return name, image, cls_label, img_box, images
        else:
            return name, image, cls_label
